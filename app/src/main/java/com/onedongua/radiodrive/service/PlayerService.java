package com.onedongua.radiodrive.service;
...
import com.onedongua.radiodrive.FavouriteManager;
import com.onedongua.radiodrive.HistoryManager;
import com.onedongua.radiodrive.IPlayerService;
import com.onedongua.radiodrive.R;
import com.onedongua.radiodrive.RadioDroidApp;
import com.onedongua.radiodrive.Utils;
import com.onedongua.radiodrive.history.TrackHistoryEntry;
import com.onedongua.radiodrive.history.TrackHistoryRepository;
import com.onedongua.radiodrive.players.PlayState;
import com.onedongua.radiodrive.players.RadioPlayer;
import com.onedongua.radiodrive.players.selector.PlayerType;
import com.onedongua.radiodrive.recording.RecordingsManager;
import com.onedongua.radiodrive.recording.RunningRecordingInfo;
...
public class PlayerService extends JobIntentService implements RadioPlayer.PlayerListener {
    ...
    public static final String PLAYER_SERVICE_TIMER_UPDATE = "com.onedongua.radiodrive.timerupdate";
    public static final String PLAYER_SERVICE_META_UPDATE = "com.onedongua.radiodrive.metaupdate";

    public static final String PLAYER_SERVICE_STATE_CHANGE = "com.onedongua.radiodrive.statechange";
    public static final String PLAYER_SERVICE_STATE_EXTRA_KEY = "state";

    public static final String PLAYER_SERVICE_METERED_CONNECTION = "com.onedongua.radiodrive.metered_connection";
    public static final String PLAYER_SERVICE_METERED_CONNECTION_PLAYER_TYPE = "PLAYER_TYPE";

    public static final String PLAYER_SERVICE_BOUND = "com.onedongua.radiodrive.playerservicebound";
