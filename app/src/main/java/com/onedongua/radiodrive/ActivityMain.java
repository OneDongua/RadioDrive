...
import static com.onedongua.radiodrive.service.MediaSessionCallback.EXTRA_STATION_UUID;
...
import com.onedongua.radiodrive.alarm.FragmentAlarm;
import com.onedongua.radiodrive.alarm.TimePickerFragment;
import com.onedongua.radiodrive.cast.CastAwareActivity;
import com.onedongua.radiodrive.interfaces.IFragmentSearchable;
import com.onedongua.radiodrive.players.PlayState;
import com.onedongua.radiodrive.players.PlayStationTask;
import com.onedongua.radiodrive.players.mpd.MPDClient;
import com.onedongua.radiodrive.players.mpd.MPDServersRepository;
import com.onedongua.radiodrive.players.selector.PlayerType;
import com.onedongua.radiodrive.service.MediaSessionCallback;
...
public class ActivityMain extends AppCompatActivity implements SearchView.OnQueryTextListener,
    ...
    public static final String ACTION_SHOW_LOADING = "com.onedongua.radiodrive.show_loading";
    public static final String ACTION_HIDE_LOADING = "com.onedongua.radiodrive.hide_loading";
