...
import static com.onedongua.radiodrive.ActivityMain.FRAGMENT_FROM_BACKSTACK;
...
import com.onedongua.radiodrive.interfaces.IApplicationSelected;
import com.onedongua.radiodrive.proxy.ProxySettingsDialog;
...
public class FragmentSettings extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener, IApplicationSelected, PreferenceFragmentCompat.OnPreferenceStartScreenCallback {
    ...
    private void refreshToplevelIcons() {
        ...
        findPreference("pref_category_data_source").setIcon(Utils.IconicsIcon(getContext(), CommunityMaterial.Icon.cmd_database));
