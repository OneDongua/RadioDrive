package com.onedongua.radiodrive.utils;
...
/**
 * This is a copy of {@link com.onedongua.radiodrive.utils.CustomFilter} with @hide removed from delayer.
 */
public abstract class CustomFilter {
     ...
     * @see #filter(CharSequence, com.onedongua.radiodrive.utils.CustomFilter.FilterListener)
     */
     ...
     * @see #publishResults(CharSequence, com.onedongua.radiodrive.utils.CustomFilter.FilterResults)
     */
    public final void filter(CharSequence constraint, com.onedongua.radiodrive.utils.CustomFilter.FilterListener listener) {
        synchronized (mLock) {
     ...
     * must be returned as a {@link com.onedongua.radiodrive.utils.CustomFilter.FilterResults} that
     * will then be published in the UI thread through
     * {@link #publishResults(CharSequence,
     * com.onedongua.radiodrive.utils.CustomFilter.FilterResults)}.</p>
     *
     ...
     * @see #filter(CharSequence, com.onedongua.radiodrive.utils.CustomFilter.FilterListener)
     * @see #publishResults(CharSequence, com.onedongua.radiodrive.utils.CustomFilter.FilterResults)
     * @see com.onedongua.radiodrive.utils.CustomFilter.FilterResults
     */
    protected abstract com.onedongua.radiodrive.utils.CustomFilter.FilterResults performFiltering(CharSequence constraint);
    ...
    protected abstract void publishResults(CharSequence constraint,
                                           com.onedongua.radiodrive.utils.CustomFilter.FilterResults results);
     ...
     * {@link com.onedongua.radiodrive.utils.CustomFilter#filter(CharSequence, com.onedongua.radiodrive.utils.CustomFilter.FilterListener)},
    ...
    private class RequestHandler extends Handler {
         ...
         * {@link com.onedongua.radiodrive.utils.CustomFilter#performFiltering} and then sending a message
            ...
            switch (what) {
                case FILTER_TOKEN:
                    ...
                    try {
                        ...
                        args.results = new com.onedongua.radiodrive.utils.CustomFilter.FilterResults();
    ...
    private class ResultsHandler extends Handler {
         ...
         * {@link com.onedongua.radiodrive.utils.CustomFilter#publishResults(CharSequence,
         * com.onedongua.radiodrive.utils.CustomFilter.FilterResults)}
    ...
    private static class RequestArguments {
         ...
         */
        com.onedongua.radiodrive.utils.CustomFilter.FilterListener listener;
    ...
    public interface Delayer {
        ...
        /**
         * @param constraint The constraint passed to {@link com.onedongua.radiodrive.utils.CustomFilter#filter(CharSequence)}
